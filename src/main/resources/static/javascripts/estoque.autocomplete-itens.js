...
Brewer.AutocompleteEstoque = (function() {
	
	function AutocompleteEstoque() {
		this.skuOuNomeInput = $('.js-sku-nome-cerveja-input');
		var htmlTemplateAutocomplete = $('#template-autocomplete-estoque').html();
		this.template = Handlebars.compile(htmlTemplateAutocomplete);
		this.emitter = $({});
		this.on = this.emitter.on.bind(this.emitter);
	}
	
	AutocompleteEstoque.prototype.iniciar = function() {
		var options = {
